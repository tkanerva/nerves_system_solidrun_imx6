defmodule NervesSystemSolidrunIMX8MP.MixProject do
  use Mix.Project

  @github_organization "tkanerva"
  @app :nerves_system_solidrun_imx6
  ...
  defp deps do
    [
      {:nerves, "~> 1.10.0 or or ~> 1.9", runtime: false},
      {:nerves_system_br, "1.23.3", runtime: false},
      {:nerves_toolchain_armhf_nerves_linux_gnueabihf, "~> 1.8", runtime: false},
  ...
  defp description do
    """
    Nerves System - SolidRun i.MX6 Hummingboard
    """
  end
